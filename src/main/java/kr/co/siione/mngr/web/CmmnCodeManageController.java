...
public class CmmnCodeManageController {
	...
	@RequestMapping(value="/mngr/CmmnCodeManage/")
	...
	@RequestMapping(value="/mngr/selectCmmnCodeTree/")
	public void selectCmmnCodeTree(HttpServletRequest request, HttpServletResponse response, @RequestParam Map<String, String> param) throws Exception  {
		List<Map<String,String>> results = null;

		Map<String, Object> result = new HashMap<String, Object>();

		try {
			results = cmmnCodeManageService.selectCmmnCodeTree(param);
	...
	@RequestMapping(value="/mngr/saveCmmnCodeInfo/")
	public void saveCmmnCodeInfo(HttpServletRequest request, HttpServletResponse response, @RequestParam Map<String, String> param) throws Exception {
		Map<String, Object> result = new HashMap<String, Object>();
		...
		try {
			result = cmmnCodeManageService.saveCmmnCodeInfo(param);
		} catch (Exception e) {
			log.error(e.getMessage());
			result.put("message", e.getMessage());
			result.put("success", false);    		
