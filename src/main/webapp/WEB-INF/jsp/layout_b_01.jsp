...
<header id="header">
	...
	<nav id="nav">
		<ul class="nav_left">
			...
			<li><a href="#"><a href="<c:url value='/goods/category/'/>">투어상품</a></li>
			<li><a href="#">여행후기</a></li>
		...
		<c:choose>
			...
			<li class="cart"><a href="<c:url value='/cart/list/'/>">장바구니</a></li>
			</c:when>
			<c:otherwise>
...
<c:if test="${main_yn ne 'Y' }"><div id="container"></c:if>
	<!--우측예약정보 시작-->
	<div id="btn_my_reservation"></div>
	<div id="btn_show_my_reservation"></div>
	<div id="show_area_my_reservation">
		<div class="show_btn_my_res"></div>
				...
				<div id="set_01">
					...
					<p class="tab_03">일정표</p>
						...
						<div id="area_airset_01">
							<p class="air_areatit">
								<span class="air_from_tit">출발</span>
						...
						<div id="area_hotelset_01">
							<p class="hotel_areatit">
								<span class="hotel_tit">모멘틱 리조트</span>
								<span class="setting"></span>
							</p>
							<dl id="sch_hotel">
								<dt>체크인</dt>
