...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    	<div class="area_photo">
        	<div class="area_search">
        		<h2><img src=<c:url value="/images/main_headline.png"/>></h2>
                <fieldset>
                <legend>검색</legend>
        ...
        <div id="product_area">
        	<ul>
            	<li>
                	<dl>
                	<dt>모멘픽리조트 <스톤마사지+호핑선택> 4일/5일</dt>
                    <dd>호핑선택시 스톤마사지 추가진행★</dd>
                    </dl>
                </li>
                <li>
                	<dl class="lst_second">
                	<dt>가비/퍼시픽세부리조트 <스톤마사지+ 팡팡랜드> 4일/5일</dt>
                ...
                <li class="lst_contact">
                <span class="txt_head">고객센터 대표번호 1588-0000<br/>(해외 82-2-0000-0000)</span><br/>
                <span class="txt_contact">서울시 종로구 평창 30길 27, 2F<br/> 
T. 070-7655-5003&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        F. 070-7655-5003<br/>    
e-mail. customer@onepasstour.com</span>
