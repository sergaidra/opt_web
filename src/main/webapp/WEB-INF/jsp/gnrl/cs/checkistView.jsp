...
function setForm(editor) {
	...
	var url = "<c:url value='/cs/saveChecklist'/>";
	var param = {};
...
function modifyNotice() {
	var frm = $("#frmBbs");
	$(frm).attr("action", "/cs/modifyChecklist");
	$(frm).submit();
}
...
<div id="container">
  ...
  <div class="inner2">
  	<div class="order_list">
	   <div class="com_stitle">세부알고가기</div>
        <div class="review_wr_box">
         ...
         <div class="bbs_bottom" style="margin-top:30px;">
 			<c:if test="${mode == 'view' and (view.WRITNG_ID == esntl_id or author_cl == 'A') }" >
                  <div class="left_btn">
			       ...
			       <div class="right_btn"> 
					...
					<c:if test="${mode == 'modify' }" >
                  	...
                  	<a href="javascript:go_04_03_01();" class="button_m2">목록</a> 
			       	</div>
