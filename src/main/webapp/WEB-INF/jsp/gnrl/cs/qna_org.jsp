        	...
        	for(var cnt = 0; cnt < data.list.length; cnt++) {
        		...
        		// 모바일
        		{
        			...
        			if(data.list[cnt].ISNEW == 'Y') {
           			...
           			td1 = $("<td></td>");
           			td1span = $("<span class='tb_font1' style='width:100%; float:left; text-align:left;'>" + strDelete + "no." + (Number(data.startIdx) + rowCnt) + " [" + data.list[cnt].USER_NM + "] [" + data.list[cnt].WRITNG_DT + "]"  + divHtml + "</span><br><span>" + data.list[cnt].OPINION_SJ + "</span>" + divNew);
