...
<div class="infor_area">
	...
	<div id="window">
		...
		<p class="a_next"></p> -->
		<p class="main_photo">
			<iframe src="<c:url value='/file/imageListIframe/'/>?file_code=${result.FILE_CODE}" width="824" height="428" scrolling="no" frameborder="0"></iframe>
	...
	<div id="infor_productarea">
		...
		<div class="infor_productarea_right">
			...
			<li <c:if test="${status.count%5 == 0}">class="pright"</c:if>>
			  <img src="<c:url value='/file/getImage/'/>?file_code=${list.FILE_CODE}&file_sn=${list.FILE_SN}" width="43" height="43"></li>
			 </c:forEach>
			</ul>
