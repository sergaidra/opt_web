...
var comboUpperCl = new Ext.create('Ext.form.ComboBox', {
	...
	store: new Ext.create('Ext.data.JsonStore', {
		autoLoad: true,
		fields:['CL_CODE', 'CL_NM', 'STAYNG_FCLTY_AT', 'DELETE_AT'],
		proxy: {
			type: 'ajax',
...
//var pnCenter = Ext.create('Ext.panel.Panel', {
//	//layout: 'border',
//	//region: 'center',
//	//autoScroll: true,
//	split: true,
...
/*var filePanel_org = Ext.create('Ext.panel.Panel', {
	title: '이미지등록',
	layout : 'border',
	padding : '5 10 5 10',
	style: {
