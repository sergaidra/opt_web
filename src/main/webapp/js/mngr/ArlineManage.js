...
Ext.define('ArlineInfo', {
	extend: 'Ext.data.Model',
	fields: ['IATA_CODE', 'ICAO_CODE', 'ARLINE_NM', 'USE_AT', 'RM', 'SORT_ORDR', 'WRITNG_DE', 'UPDT_DE', 'CRUD']
});
...
//	title: '보관함 목록',
	...
	columns: [{
		...
		width: 100,
		align: 'center',
		editor: {xtype:'textfield', allowBlank: false, maxLength: 2, enforceMaxLength: true, fieldStyle: {'ime-mode':'disabled'}},
		dataIndex: 'IATA_CODE'
	},{
		text: 'ICAO 코드',
		width: 100,
		style: 'text-align:',
		align: 'center',
		editor: {xtype:'textfield', allowBlank: true, maxLength: 3, enforceMaxLength: true, fieldStyle: {'ime-mode':'disabled'}},
		dataIndex: 'ICAO_CODE'
	},{
		text: '항공사 명',
		width: 200,
