...
var frFile = Ext.create('Ext.form.Panel', {
	...
	items: [{
		...
		items: [{
			xtype: 'fieldset',
			title: '<span style="font-weight:bold;">배너 등록</span>',
			padding: '10 20 10 10',
			items: [{
				xtype: 'fieldcontainer',
				layout: 'hbox',
					...
					listeners: {
						click: function (btn, e, opts) {
							...
							if (form.isValid()) {
								...
								Ext.Msg.alert('확인', '모든 항목은 필수입력입니다.');
 ...
 * 이미지목록 grid
 */
Ext.define('BannerInfo', {
	extend: 'Ext.data.Model',
	fields: [ {name:'BANNER_SN', type:'string'}
...
var gridFile = Ext.create('Ext.grid.Panel', {
	...
	columns: [{
		...
		sortable: false,
		menuDisabled: true,
		editor: {xtype:'textfield', allowBlank: false, maxLength: 200, enforceMaxLength: true, fieldStyle: {'ime-mode':'disabled'}},
		dataIndex: 'LINK_URL'
	},{
		text: '시작일자',
		width: 110,
...
var imageTpl = new Ext.XTemplate(
	...
	,'<table width="97%">'
	,'<tpl for=".">'
	,'{[xindex % 2 == 1 ? "<tr height=100 valign=top>" : ""]}'
